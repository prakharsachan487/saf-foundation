...
const SAF_TRANSLATIONS = {
  en: {
    ...
    help2_btn: 'Volunteer',
    help3_title: 'Support Campaign',
    help3_desc: 'Directly fund a high-impact initiative like a smart digital classroom, solar clean water well, or healthcare van.',
    help3_btn: 'Support Campaign',
  ...
  hi: {
    ...
    help3_title: 'अभियान का समर्थन करें',
    help3_desc: 'स्मार्ट डिजिटल कक्षा, सौर कुआं या चिकित्सा वैन जैसे प्रभावशाली अभियान का सीधे समर्थन करें।',
    help3_btn: 'समर्थन करें',
